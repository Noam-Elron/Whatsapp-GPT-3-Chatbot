...
def main_process(user_phone_details, incoming_msg):
    ...
    # Create new database object to handle queries
    with DatabaseConnection() as db_conn:
        # Create new user object to handle actually using the database(login, input, etc)
        user = Client(db_conn, user_phone_details)
